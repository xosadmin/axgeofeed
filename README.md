...
3. Load ``db.sql`` to your MariaDB database, and finalise ``config.yaml`` config. For example, please refer to [example-config.yaml](https://github.com/xosadmin/axgeofeed/blob/main/example-config.yaml)
