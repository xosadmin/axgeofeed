...
CREATE TABLE `user_asset` (
    ...
    `systemCreated` BOOLEAN NOT NULL DEFAULT FALSE,
...
INSERT INTO `user_asset`(id,userid,systemCreated,asset_name)
VALUES("00000000","00000000",1,"admin_MANUAL");
...
CREATE TABLE `geofeed` (
    ...
    `included_in_geofeed` BOOLEAN NOT NULL DEFAULT TRUE,
